...
const AnimalDetails = () => {
    ...
    useEffect(() => {
        fetch('/animals.json')
            .then(res => res.json())
            .then(data => {
                const foundAnimal = data.find(a => a.animalId === parseInt(animalId));
                setAnimals(foundAnimal);
            });
    }, [animalId]);

    if (!animal) return <Loading></Loading>
            ...
            <div>
                <div className="p-5 bg-gray-100  ">
                    <div className="md:flex  ">
                        <div>
                            <img className="h-[350px] w-[350px] rounded-lg" src={animal.image} alt={animal.animalName} />
                        </div>
                        <div className="ml-[50px]">
                            <div className="md:ml-10 ">
                                <h1 className=" text-4xl font-bold">{animal.animalName}</h1>
                                <p className="mt-2 text-xl">
                                    Price: <span className="text-[#632EE3] text-2xl">{animal.price}</span>
                                </p>
                            ...
                            <div className=" ml-10 mt-8">
                                ...
                                <div className="mt-5 md:mt-0">
                                    ...
                                    <p>Available Stock</p>
                                    <h1 className="font-bold text-5xl">{animal.availableStock}</h1>
                                </div>

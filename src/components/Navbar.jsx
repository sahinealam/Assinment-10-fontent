...
const Navbar = () => {
    ...
    return (
        <div className="flex flex-col gap-3 md:flex-row justify-between items-center">
            ...
            <div className=''>
                <h1 className='text-green-600 font-extrabold text-2xl'>GreenNest</h1>
            </div>
            <div className="nav flex gap-5">
                <NavLink to="/" className={({ isActive }) => isActive ?
                    "text-green-500 underline" : ""}>Home</NavLink>
                <NavLink to="/animals" className={({ isActive }) => isActive ?
                    "text-green-500 underline" : ""}>Animals</NavLink>
                <NavLink to="/myprofile" className={({ isActive }) => isActive ?
                    "text-green-500 underline" : ""}>My Profile</NavLink>
            </div>
